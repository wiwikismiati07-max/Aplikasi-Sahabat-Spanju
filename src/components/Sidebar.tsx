    ...
    <>
      ...
      >
        ...
        <div className="px-4 pt-3 pb-1 flex items-center justify-between text-xs flex-shrink-0">
          <div
            onClick={() => handleItemClick('menu_utama')}
            className="flex items-center gap-1.5 font-bold text-emerald-800 text-[11px] uppercase tracking-wider cursor-pointer hover:text-emerald-950 transition-colors"
            title="Akses Semua Pilihan Menu Aplikasi"
          >
          ...
          <button
            type="button"
            onClick={() => handleItemClick('menu_utama')}
            className="text-[10px] font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 px-2 py-0.5 rounded-md cursor-pointer transition-colors"
            title="Lihat Daftar Semua Menu"
          >
            18 Modul
          </button>
        </div>
