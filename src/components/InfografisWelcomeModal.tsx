...
export const InfografisWelcomeModal: React.FC<InfografisWelcomeModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-3 bg-slate-950/75 backdrop-blur-sm overflow-hidden animate-in fade-in duration-150">
      ...
      {downloadSuccess && (
        <div className="fixed top-6 right-6 z-50 bg-emerald-700 text-white px-5 py-3 rounded-2xl shadow-2xl flex items-center gap-3 border border-emerald-500 animate-in fade-in slide-in-from-top-4">
          ...
          <div>
            ...
            <p className="text-[11px] text-emerald-100">File gambar telah tersimpan di folder unduhan / galeri Anda.</p>
          </div>
        </div>
      )}
      ...
      >
        {/* 1. TOP HEADER BAR */}
        <div className="px-4 sm:px-6 py-3 border-b border-slate-200 bg-white flex flex-wrap items-center justify-between gap-2.5 flex-shrink-0">
          {/* Left info */}
        ...
        <div className="flex-1 overflow-y-auto bg-gradient-to-b from-[#dff2ea] via-[#edf7f2] to-[#f8fbf9] p-4 sm:p-8 flex flex-col items-center">
          ...
          <div className="w-full max-w-3xl flex flex-wrap items-center justify-center gap-3 py-2 text-center text-xs text-slate-500">
            <span>Format: JPG HD</span>
            <span>•</span>
            <span>Standar Cetak: A4 Portrait / PDF</span>
            <span>•</span>
            <button
              type="button"
              onClick={handlePrint}
